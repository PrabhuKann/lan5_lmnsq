...
<body>
	...
	<div class="container">
		...
		<form action="/Lab20220927/students/search" class="form-inline">

			<!-- Add a button -->
			<a href="/Lab20220927/students/showFormForAdd"
				...
				<c:forEach items="${Students}" var="tempStudent">
					<tr>
						...
						<td>
							...
							href="/Lab20220927/students/showFormForUpdate?studentId=${tempStudent.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/Lab20220927/students/delete?studentId=${tempStudent.id}"
